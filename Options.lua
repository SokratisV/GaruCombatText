...
local function fillActions(c, reflow)
    ...
    Checkbox(c, "Show avoid type (Dodge/Parry/...)", function() return a.showLabel end, function(v) a.showLabel = v end)
...
local function build()
    ...
    tabX = 14
    makeTab(1, "Healing", heal)
    makeTab(2, "Damage Taken", taken)
    makeTab(3, "Damage Dealt", dmg)
    makeTab(4, "Actions", act)
